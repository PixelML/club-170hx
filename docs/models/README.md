...
| GLM-5.3-Flash | 44.8 tok/s aggregate decode (c=8, 4 cards, EXL3 4.05bpw) | Measured; single-request context capped at ~2,048 tokens under the standing Q8 KV cache | [glm-5.3-flash.md](glm-5.3-flash.md) |
