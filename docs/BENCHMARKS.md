...
| Qwen3.8-27B | W4A16 GPTQ · vLLM sm80, **Jev classification reads** (`/v1/systemone`) | 1 · TP1, no spec decode | 8,192 | c=1 (reads); 2 concurrent for the determinism check | — (no generation) | — (no generation) | 7.1 reads/s (p50 141.7 ms/read, warm prefix cache; 133.0 ms cache-busted) | — | — | accuracy 0.571 (n=42 author-labelled, 95% CI 0.42-0.71); Brier 0.5494; ECE 0.274 at T=1 → 0.223 at fitted T=2.16, leave-one-out ECE 0.301; label distributions bit-identical on repeat and across 2 concurrent requests; option-order L1 shift up to 0.639 with argmax flip | 180 W cap; shared with one other idle job; no Xid/ECC | — | Publication-safe; classification path only, not a calibration claim | [results/2026-09-20-qwen3.8-27b-w4a16-jev-1card-vllm](results/2026-09-20-qwen3.8-27b-w4a16-jev-1card-vllm/README.md) · [notebook](notebooks/2026-09-20-qwen3.8-27b-w4a16-jev-1card-vllm.ipynb) |
